...
TIMESTAMP('2000-01-01 23:59:59.999Z') AS end_aa  ) AS birthDate_aa );
...
TIMESTAMP('2019-12-31 11:53:47.999-05:00') AS end_aa  ) AS effectiveDateTime_aa,
...
TIMESTAMP('2019-11-30 11:53:47.999-05:00') AS end_aa  ) AS effectiveDateTime_aa,
STRUCT ( 8.22 AS value,
'http://unitsofmeasure.org' AS system,
...
a1c_2 AS (
	SELECT subject.reference_id_aa AS PatientId,
		...
		effectiveDateTime_aa.end_aa AS effectiveDateTime_end
...
a1c_1 AS (	
	...
	FROM Observation
		INNER JOIN a1c_2_elevated 
			...
			AND DATETIME(effectiveDateTime_aa.end_aa) < DATETIME_ADD(DATETIME(a1c_2_elevated.effectiveDateTime_start), INTERVAL -1 DAY)
			AND DATETIME(effectiveDateTime_aa.end_aa) > DATETIME_ADD(DATETIME(a1c_2_elevated.effectiveDateTime_start), INTERVAL -60 DAY)
     INNER JOIN pt
